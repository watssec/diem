...
procedure {:timeLimit 40} $2_Test_sort$verify(_$t0: $Mutation (Vec (int))) returns ($ret0: $Mutation (Vec (int)))
{
    ...
    assume {:print "$at(3,133,134)"} true;
    $t11 := $Dereference($t0);
    ...
    if ($abort_flag) {
        assume {:print "$at(3,118,135)"} true;
        $t13 := $abort_code;
    ...
    assume {:print "$at(3,154,155)"} true;
    $t14 := 0;
...
L0:
    ...
    assume {:print "$at(3,195,569)"} true;
L2:

    // assert Eq<num>(Len<u64>($t0), Len<u64>($t6)) at ../../../../swap/src/modules/module.move:11:21+32
    assume {:print "$at(3,221,253)"} true;
    assert {:msg "assert_failed(3,221,253): base case of the loop invariant does not hold"}
      $IsEqual'num'(LenVec($Dereference($t0)), LenVec($t6));

    // assert Le($t10, Len<u64>($t0)) at ../../../../swap/src/modules/module.move:12:21+22
    assume {:print "$at(3,274,296)"} true;
    assert {:msg "assert_failed(3,274,296): base case of the loop invariant does not hold"}
    ...
    assume {:print "$at(3,317,373)"} true;
    assert {:msg "assert_failed(3,317,373): base case of the loop invariant does not hold"}
    ...
    assume {:print "$at(3,394,461)"} true;
    assert {:msg "assert_failed(3,394,461): base case of the loop invariant does not hold"}
    ...
    assume {:print "$at(3,594,595)"} true;
    $t16 := 1;
    assume $IsValid'u64'($t16);
    ...
    if ($abort_flag) {
        assume {:print "$at(3,593,594)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L18;
    }
    ...
    assume {:print "$at(3,171,1430)"} true;
...
L5:
    ...
    assume {:print "$at(3,639,640)"} true;
L4:
    ...
    assume {:print "$at(3,686,1157)"} true;
L14:

    // assert Eq<num>(Len<u64>($t0), Len<u64>($t7)) at ../../../../swap/src/modules/module.move:24:25+32
    assume {:print "$at(3,716,748)"} true;
    assert {:msg "assert_failed(3,716,748): base case of the loop invariant does not hold"}
      $IsEqual'num'(LenVec($Dereference($t0)), LenVec($t7));

    // assert Le($t19, Sub(Sub($t12, $t10), 1)) at ../../../../swap/src/modules/module.move:25:25+21
    assume {:print "$at(3,773,794)"} true;
    assert {:msg "assert_failed(3,773,794): base case of the loop invariant does not hold"}
      ($t19 <= (($t12 - $t10) - 1));

    // assert forall k: Range(0, $t19): Le(Index($t0, k), Index($t0, $t19)) at ../../../../swap/src/modules/module.move:26:25+41
    assume {:print "$at(3,819,860)"} true;
    assert {:msg "assert_failed(3,819,860): base case of the loop invariant does not hold"}
    ...
    assume {:print "$at(3,987,1043)"} true;
    assert {:msg "assert_failed(3,987,1043): base case of the loop invariant does not hold"}
      (var $range_0 := $Range(0, ($t12 - $t10)); (var $range_1 := $Range(($t12 - $t10), $t12); (forall $i_2: int, $i_3: int :: $InRange($range_0, $i_2) ==> $InRange($range_1, $i_3) ==> (var p := $i_2;
    (var q := $i_3;
    ((ReadVec($Dereference($t0), p) <= ReadVec($Dereference($t0), q))))))));
    ...
    assume {:print "$at(3,1068,1135)"} true;
    assert {:msg "assert_failed(3,1068,1135): base case of the loop invariant does not hold"}
      (var $range_0 := $Range(($t12 - $t10), $t12); (var $range_1 := $Range(($t12 - $t10), $t12); (forall $i_2: int, $i_3: int :: $InRange($range_0, $i_2) ==> $InRange($range_1, $i_3) ==> (var m := $i_2;
    (var n := $i_3;
    (((m <= n) ==> (ReadVec($Dereference($t0), m) <= ReadVec($Dereference($t0), n)))))))));
    ...
    assume {:print "$at(3,1185,1186)"} true;
    ...
    if ($abort_flag) {
        assume {:print "$at(3,1187,1188)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L18;
    }
    ...
    assume {:print "$at(3,658,1388)"} true;
...
L8:
    ...
    assume {:print "$at(3,1256,1257)"} true;
L7:
    ...
    if ($abort_flag) {
        assume {:print "$at(3,1237,1260)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L18;
    }
    ...
    if ($abort_flag) {
        assume {:print "$at(3,1264,1289)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L18;
    }
...
L10:
    ...
    assume {:print "$at(3,1329,1330)"} true;
L12:
    ...
    if ($abort_flag) {
        assume {:print "$at(3,1334,1335)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L18;
    }
    ...
    if ($abort_flag) {
        assume {:print "$at(3,1316,1337)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L18;
    }
    ...
    assume {:print "$at(3,1365,1366)"} true;
L13:
    ...
    if ($abort_flag) {
        assume {:print "$at(3,1367,1368)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L18;
    }
    ...
    assume {:print "$at(3,1410,1411)"} true;
L9:
    ...
    if ($abort_flag) {
        assume {:print "$at(3,1412,1413)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L18;
    }
    ...
    assume {:print "$at(3,145,1440)"} true;
L6:
...
L15:
    ...
    assume {:print "$at(3,221,253)"} true;
    assert {:msg "assert_failed(3,221,253): induction case of the loop invariant does not hold"}
      $IsEqual'num'(LenVec($Dereference($t0)), LenVec($t8));

    // assert Le($t34, Len<u64>($t0)) at ../../../../swap/src/modules/module.move:12:21+22
    assume {:print "$at(3,274,296)"} true;
    assert {:msg "assert_failed(3,274,296): induction case of the loop invariant does not hold"}
    ...
    assume {:print "$at(3,317,373)"} true;
    assert {:msg "assert_failed(3,317,373): induction case of the loop invariant does not hold"}
    ...
    assume {:print "$at(3,394,461)"} true;
    assert {:msg "assert_failed(3,394,461): induction case of the loop invariant does not hold"}
...
L16:
    ...
    assume {:print "$at(3,716,748)"} true;
    assert {:msg "assert_failed(3,716,748): induction case of the loop invariant does not hold"}
      $IsEqual'num'(LenVec($Dereference($t0)), LenVec($t9));

    // assert Le($t32, Sub(Sub($t12, $t10), 1)) at ../../../../swap/src/modules/module.move:25:25+21
    assume {:print "$at(3,773,794)"} true;
    assert {:msg "assert_failed(3,773,794): induction case of the loop invariant does not hold"}
      ($t32 <= (($t12 - $t10) - 1));

    // assert forall k: Range(0, $t32): Le(Index($t0, k), Index($t0, $t32)) at ../../../../swap/src/modules/module.move:26:25+41
    assume {:print "$at(3,819,860)"} true;
    assert {:msg "assert_failed(3,819,860): induction case of the loop invariant does not hold"}
      (var $range_0 := $Range(0, $t32); (forall $i_1: int :: $InRange($range_0, $i_1) ==> (var k := $i_1;
    ((ReadVec($Dereference($t0), k) <= ReadVec($Dereference($t0), $t32))))));

    // assert forall p: Range(0, Sub($t12, $t10)), q: Range(Sub($t12, $t10), $t12): Le(Index($t0, p), Index($t0, q)) at ../../../../swap/src/modules/module.move:28:25+56
    assume {:print "$at(3,987,1043)"} true;
    assert {:msg "assert_failed(3,987,1043): induction case of the loop invariant does not hold"}
      (var $range_0 := $Range(0, ($t12 - $t10)); (var $range_1 := $Range(($t12 - $t10), $t12); (forall $i_2: int, $i_3: int :: $InRange($range_0, $i_2) ==> $InRange($range_1, $i_3) ==> (var p := $i_2;
    (var q := $i_3;
    ((ReadVec($Dereference($t0), p) <= ReadVec($Dereference($t0), q))))))));
    ...
    // assert forall m: Range(Sub($t12, $t10), $t12), n: Range(Sub($t12, $t10), $t12): Implies(Le(m, n), Le(Index($t0, m), Index($t0, n))) at ../../../../swap/src/modules/module.move:29:25+67
    assume {:print "$at(3,1068,1135)"} true;
    assert {:msg "assert_failed(3,1068,1135): induction case of the loop invariant does not hold"}
      (var $range_0 := $Range(($t12 - $t10), $t12); (var $range_1 := $Range(($t12 - $t10), $t12); (forall $i_2: int, $i_3: int :: $InRange($range_0, $i_2) ==> $InRange($range_1, $i_3) ==> (var m := $i_2;
    (var n := $i_3;
    (((m <= n) ==> (ReadVec($Dereference($t0), m) <= ReadVec($Dereference($t0), n)))))))));
    ...
    assume {:print "$at(3,1445,1446)"} true;
L17:
    ...
    assume {:print "$at(3,1487,1558)"} true;
    assert {:msg "assert_failed(3,1487,1558): post-condition does not hold"}
