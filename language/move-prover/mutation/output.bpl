...
procedure {:timeLimit 40} $2_Test_sort$verify(_$t0: $Mutation (Vec (int))) returns ($ret0: $Mutation (Vec (int)))
{
    ...
    assume {:print "$at(20,99,100)"} true;
    $t10 := 0;
    ...
    assume {:print "$at(20,133,134)"} true;
    $t11 := $Dereference($t0);
    ...
    if ($abort_flag) {
        assume {:print "$at(20,118,135)"} true;
        $t13 := $abort_code;
    ...
    assume {:print "$at(20,154,155)"} true;
    $t14 := 0;
    ...
    // if ($t15) goto L0 else goto L18 at ../../../swap/src/modules/module.move:8:9+1295
    if ($t15) { goto L0; } else { goto L18; }
...
L1:
    ...
    assume {:print "$at(20,195,569)"} true;
L0:

    // assert Eq<num>(Len<u64>($t0), Len<u64>($t6)) at ../../../swap/src/modules/module.move:11:21+32
    assume {:print "$at(20,221,253)"} true;
    assert {:msg "assert_failed(20,221,253): base case of the loop invariant does not hold"}
      $IsEqual'num'(LenVec($Dereference($t0)), LenVec($t6));

    // assert Le($t10, Len<u64>($t0)) at ../../../swap/src/modules/module.move:12:21+22
    assume {:print "$at(20,274,296)"} true;
    assert {:msg "assert_failed(20,274,296): base case of the loop invariant does not hold"}
    ...
    assume {:print "$at(20,317,373)"} true;
    assert {:msg "assert_failed(20,317,373): base case of the loop invariant does not hold"}
    ...
    assume {:print "$at(20,394,461)"} true;
    assert {:msg "assert_failed(20,394,461): base case of the loop invariant does not hold"}
    ...
    assume {:print "$at(20,594,595)"} true;
    $t16 := 1;
    assume $IsValid'u64'($t16);
    ...
    if ($abort_flag) {
        assume {:print "$at(20,593,594)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L17;
    }
...
L3:
    ...
    assume {:print "$at(20,686,1157)"} true;
L12:

    // assert Eq<num>(Len<u64>($t0), Len<u64>($t7)) at ../../../swap/src/modules/module.move:24:25+32
    assume {:print "$at(20,716,748)"} true;
    assert {:msg "assert_failed(20,716,748): base case of the loop invariant does not hold"}
      $IsEqual'num'(LenVec($Dereference($t0)), LenVec($t7));

    // assert Le($t19, Sub(Sub($t12, $t10), 1)) at ../../../swap/src/modules/module.move:25:25+21
    assume {:print "$at(20,773,794)"} true;
    assert {:msg "assert_failed(20,773,794): base case of the loop invariant does not hold"}
      ($t19 <= (($t12 - $t10) - 1));

    // assert forall k: Range(0, $t19): Le(Index($t0, k), Index($t0, $t19)) at ../../../swap/src/modules/module.move:26:25+41
    assume {:print "$at(20,819,860)"} true;
    assert {:msg "assert_failed(20,819,860): base case of the loop invariant does not hold"}
    ...
    assume {:print "$at(20,987,1043)"} true;
    assert {:msg "assert_failed(20,987,1043): base case of the loop invariant does not hold"}
      (var $range_0 := $Range(0, ($t12 - $t10)); (var $range_1 := $Range(($t12 - $t10), $t12); (forall $i_2: int, $i_3: int :: $InRange($range_0, $i_2) ==> $InRange($range_1, $i_3) ==> (var p := $i_2;
    (var q := $i_3;
    ((ReadVec($Dereference($t0), p) <= ReadVec($Dereference($t0), q))))))));
    ...
    assume {:print "$at(20,1068,1135)"} true;
    assert {:msg "assert_failed(20,1068,1135): base case of the loop invariant does not hold"}
      (var $range_0 := $Range(($t12 - $t10), $t12); (var $range_1 := $Range(($t12 - $t10), $t12); (forall $i_2: int, $i_3: int :: $InRange($range_0, $i_2) ==> $InRange($range_1, $i_3) ==> (var m := $i_2;
    (var n := $i_3;
    (((m <= n) ==> (ReadVec($Dereference($t0), m) <= ReadVec($Dereference($t0), n)))))))));
    ...
    assume {:print "$at(20,1185,1186)"} true;
    ...
    if ($abort_flag) {
        assume {:print "$at(20,1187,1188)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L17;
    }
...
L6:
    ...
    if ($abort_flag) {
        assume {:print "$at(20,1237,1260)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L17;
    }
    ...
    if ($abort_flag) {
        assume {:print "$at(20,1286,1287)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L17;
    }
    ...
    if ($abort_flag) {
        assume {:print "$at(20,1264,1289)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L17;
    }
    ...
    // if ($t28) goto L9 else goto L10 at ../../../swap/src/modules/module.move:33:21+107
    if ($t28) { goto L9; } else { goto L10; }

    // label L10 at ../../../swap/src/modules/module.move:33:21+107
L10:

    // goto L11 at ../../../swap/src/modules/module.move:33:21+107
    goto L11;

    // label L9 at ../../../swap/src/modules/module.move:34:38+1
    assume {:print "$at(20,1329,1330)"} true;
L9:
    ...
    if ($abort_flag) {
        assume {:print "$at(20,1334,1335)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L17;
    }
    ...
    if ($abort_flag) {
        assume {:print "$at(20,1316,1337)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L17;
    }
    ...
    assume {:print "$at(20,1365,1366)"} true;
L11:
    ...
    if ($abort_flag) {
        assume {:print "$at(20,1367,1368)"} true;
        $t13 := $abort_code;
        assume {:print "$track_abort(1,0):", $t13} $t13 == $t13;
        goto L17;
    }
    ...
    // goto L15 at ../../../swap/src/modules/module.move:35:29+1
    goto L15;
...
L8:
    ...
    // goto L14 at ../../../swap/src/modules/module.move:37:26+1
    goto L14;

    // label L5 at ../../../swap/src/modules/module.move:8:9+1295
    assume {:print "$at(20,145,1440)"} true;
L5:

    // destroy($t0) at ../../../swap/src/modules/module.move:8:9+1295

    // goto L13 at ../../../swap/src/modules/module.move:8:9+1295
    goto L13;

    // label L2 at ../../../swap/src/modules/module.move:8:9+1295
L2:

    // destroy($t0) at ../../../swap/src/modules/module.move:8:9+1295

    // label L13 at ../../../swap/src/modules/module.move:8:9+1295
L13:
    ...
    // goto L16 at ../../../swap/src/modules/module.move:8:9+1295
    goto L16;

    // label L14 at ../../../swap/src/modules/module.move:8:9+1295
...
L14:
    ...
    assume {:print "$at(20,221,253)"} true;
    assert {:msg "assert_failed(20,221,253): induction case of the loop invariant does not hold"}
      $IsEqual'num'(LenVec($Dereference($t0)), LenVec($t8));

    // assert Le($t34, Len<u64>($t0)) at ../../../swap/src/modules/module.move:12:21+22
    assume {:print "$at(20,274,296)"} true;
    assert {:msg "assert_failed(20,274,296): induction case of the loop invariant does not hold"}
    ...
    assume {:print "$at(20,317,373)"} true;
    assert {:msg "assert_failed(20,317,373): induction case of the loop invariant does not hold"}
    ...
    assume {:print "$at(20,394,461)"} true;
    assert {:msg "assert_failed(20,394,461): induction case of the loop invariant does not hold"}
    ...
    // label L15 at ../../../swap/src/modules/module.move:14:21+67
...
L15:
    ...
    assume {:print "$at(20,716,748)"} true;
    assert {:msg "assert_failed(20,716,748): induction case of the loop invariant does not hold"}
      $IsEqual'num'(LenVec($Dereference($t0)), LenVec($t9));

    // assert Le($t32, Sub(Sub($t12, $t10), 1)) at ../../../swap/src/modules/module.move:25:25+21
    assume {:print "$at(20,773,794)"} true;
    assert {:msg "assert_failed(20,773,794): induction case of the loop invariant does not hold"}
      ($t32 <= (($t12 - $t10) - 1));

    // assert forall k: Range(0, $t32): Le(Index($t0, k), Index($t0, $t32)) at ../../../swap/src/modules/module.move:26:25+41
    assume {:print "$at(20,819,860)"} true;
    assert {:msg "assert_failed(20,819,860): induction case of the loop invariant does not hold"}
      (var $range_0 := $Range(0, $t32); (forall $i_1: int :: $InRange($range_0, $i_1) ==> (var k := $i_1;
    ((ReadVec($Dereference($t0), k) <= ReadVec($Dereference($t0), $t32))))));

    // assert forall p: Range(0, Sub($t12, $t10)), q: Range(Sub($t12, $t10), $t12): Le(Index($t0, p), Index($t0, q)) at ../../../swap/src/modules/module.move:28:25+56
    assume {:print "$at(20,987,1043)"} true;
    assert {:msg "assert_failed(20,987,1043): induction case of the loop invariant does not hold"}
      (var $range_0 := $Range(0, ($t12 - $t10)); (var $range_1 := $Range(($t12 - $t10), $t12); (forall $i_2: int, $i_3: int :: $InRange($range_0, $i_2) ==> $InRange($range_1, $i_3) ==> (var p := $i_2;
    (var q := $i_3;
    ((ReadVec($Dereference($t0), p) <= ReadVec($Dereference($t0), q))))))));
    ...
    // assert forall m: Range(Sub($t12, $t10), $t12), n: Range(Sub($t12, $t10), $t12): Implies(Le(m, n), Le(Index($t0, m), Index($t0, n))) at ../../../swap/src/modules/module.move:29:25+67
    assume {:print "$at(20,1068,1135)"} true;
    assert {:msg "assert_failed(20,1068,1135): induction case of the loop invariant does not hold"}
      (var $range_0 := $Range(($t12 - $t10), $t12); (var $range_1 := $Range(($t12 - $t10), $t12); (forall $i_2: int, $i_3: int :: $InRange($range_0, $i_2) ==> $InRange($range_1, $i_3) ==> (var m := $i_2;
    (var n := $i_3;
    (((m <= n) ==> (ReadVec($Dereference($t0), m) <= ReadVec($Dereference($t0), n)))))))));
    ...
    assume {:print "$at(20,1445,1446)"} true;
L16:
    ...
    assume {:print "$at(20,1487,1558)"} true;
    assert {:msg "assert_failed(20,1487,1558): post-condition does not hold"}
